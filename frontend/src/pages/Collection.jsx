    ...
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
      ...
      <div className="min-w-60">
        <p onClick={() => setShowFilter(!showFilter)} className="my-2 text-xl flex items-center cursor-pointer">FILTERS
          <img src={assets.dropdown_icon} className={`h-3 pl-4 sm:hidden ${showFilter ? 'rotate-90' : ''}`} alt="" />
        </p>
        {/* category filter */}
        <div
        ...
        >
          ...
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            ...
            <p className="flex gap-2 ">
              <input type="checkbox" className="w-3" value={"Summerwear"} onChange={toggleSubCategory}/>Summer-wear
            </p>
          </div>
        </div>
      </div>
